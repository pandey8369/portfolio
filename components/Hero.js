      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              Full Stack Developer with over 2 years of experience in building scalable, production-ready web applications. Specialist in Next.js, Django, and eCommerce optimization with a focus on performance and user experience.
            </motion.p>
